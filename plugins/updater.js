    ...
    if (cmd === "update") {
        ...
        try {
            ...
            const { data: commitData } = await axios.get(
                "https://api.github.com/repos/Peacemaker-cyber/PEACE-MD/commits/main"
            );
            ...
            const response = await axios({
                method: 'get',
                url: "https://github.com/Peacemaker-cyber/PEACE-MD/archive/main.zip"",
                responseType: 'stream'
            });
            ...
            const sourcePath = path.join(extractPath, "XEON-XMD-main");
            await copyFolderSync(sourcePath, process.cwd(), ['package.json', 'config.js', '.env']);
