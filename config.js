...
const config = {
  ...
  BOT_NAME: process.env.BOT_NAME || "SAKONA-MD",
  BOT: process.env.BOT || "hello 👋",
  NEW_CMD: process.env.NEW_CMD || "ᴀᴅᴅᴠᴀʀ\n│ sᴜᴅᴏ\n| sakona",
  CAPTION: process.env.CAPTION || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴀᴋᴏɴᴀ ᴍᴅ",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || 'Status Viewed by sᴀᴋᴏɴᴀ-ᴍᴅ',
  ...
  DELETED_MESSAGES_CHAT_ID: process.env.DELETED_MESSAGES_CHAT_ID || "923079749129@s.whatsapp.net",
  OWNER_NAME: process.env.OWNER_NAME || "❁ ════ ❃• Peacemaker •❃ ═",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923079749129",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "923079749129",
  ...
  TARGET_NUMBER: process.env.TARGET_NUMBER || "923079749129"                    // target phone number for status messages
};
